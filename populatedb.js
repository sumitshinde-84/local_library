...
console.log(
  ...
  const Book = require("./local_library/models/book");
  const Author = require("./local_library/models/author");
  const Genre = require("./local_library/models/genre");
  const BookInstance = require("./local_library/models/bookinstance");
